      ...
      return(
          <View>
            ...
            <View style={{flexDirection:'row',height: 60,flex: 1,justifyContent:'space-between',}}>
              <Text style={{color:'#fff',fontWeight: 'bold',  lineHeight: 60, }}>{"item.item.title"}</Text>
...
favourite(id){
  ...
  this.props.favaction.fetchFavCreate(path,bundle,this.props.postAction,true,this.props.postDetailAction);
}
    ...
    return(
        ...
        <View style={{flex:1,backgroundColor:"#ffffff",marginTop:Platform.OS=='ios'?20:0}}>
          ...
          <View style={{flex:1,backgroundColor:"#ffffff",}}> 
              ...
              <Text style={{ color: '#000',fontWeight: 'bold', height: 60, lineHeight: 60, flex: 1 }}>{"item.user.username"}</Text>
