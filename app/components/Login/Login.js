...
//     console.log('this.isFormValid()1::',this.state.fcmToken);
...
//       that.props.loginAction.fetchLoginData(path,bundle,that.props.navigation,that.state.fcmToken);
         ...
         // var api = `https://graph.facebook.com/me?access_token=${e.credentials.token}`; 
          ...
          .then((responseData) => {
           ...
           console.log("fb:responseData",responseData);
              ...
              if(responseData){
                that.setState({getInfoModalVisible:true,firstname:e.profile.first_name,lastname:e.profile.last_name,socialData:responseData,socialType:'facebookid'});
            ...
            <View style={CommonStyle.mainFullScreenContainer}>
                ...
                */}
                  ...
                  <View style={{justifyContent:'center',alignItems:'center'}}>
                    ...
                    <View style={Platform.OS=='ios'?styles.loginBtn:{marginBottom:20,marginTop:20}}>
{/**
                    <FBLogin
                        buttonView={
                          <FBLoginView/>
