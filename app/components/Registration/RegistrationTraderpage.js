...
class RegistrationTraderpage extends ValidationComponent {
    ...
    return(
        <View style={{flex:1,backgroundColor:color.mainbackground}}>
          ...
          <ScrollView>
            ...
            <TouchableOpacity onPress={()=>this.props.navigation.navigate("RegistrationTraderVerify")} style={[CommonStyle.submitBtn,{backgroundColor:color.text3}]}>
...
RegistrationTraderpage.defaultProps = {
  messages : Messages,
  rules:Rules
  };
module.exports = RegistrationTraderpage;
