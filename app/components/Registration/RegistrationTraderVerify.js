...
class RegistrationTraderVerify extends ValidationComponent {
    ...
    return(
        <View style={{flex:1,backgroundColor:color.mainbackground}}>
          ...
          <ScrollView>
            ...
            <TouchableOpacity onPress={()=>this.props.navigation.navigate("ComoditySelection")} style={[CommonStyle.submitBtn,{backgroundColor:color.text3}]}>
              <Text style={CommonStyle.submitBtnText}>Verify</Text>
            </TouchableOpacity> 
...
RegistrationTraderVerify.defaultProps = {
  messages : Messages,
  rules:Rules
  };
module.exports = RegistrationTraderVerify;
