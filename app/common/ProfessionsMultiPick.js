...
console.log('####',this.state.modalVisible)
 ...
 <View style={{flexDirection: 'column',alignItems:"center",justifyContent:"center",marginTop:Platform.OS=='ios'?20:0,height:Platform.OS=='ios'?Screen.height:Screen.height/1.8,paddingTop:Platform.OS=='ios'?10:0,
 // backgroundColor:"rgba(0,0,0,0.4)"
}} elevation={5}>
{/** 
        <Toolbar
            leftElement="arrow-back" 
            centerElement="Select your Friends"
            onLeftElementPress={() =>{this.setState({modalVisible:false},()=>{this.oncloseModal(true)});}}
            searchable={{
              autoFocus: true,
              placeholder: 'Search',
              onChangeText: (text) => {
        ...
        />
**/}
        <View style={{height:Screen.height/1.8,width:Screen.width-40,}}>
          <View style={{height:40,backgroundColor:color.text3,flexDirection:"row",justifyContent:"space-between"}}>
                <TouchableOpacity  style={{height:40,justifyContent:"center",marginLeft:5}} onPress={()=>{this.setState({modalVisible:false},()=>{this.oncloseModal(true)});}}>
                <View>
                <IconSimple name="close" color={"#FFFFFF"} backgroundColor={"red"} size={25} style={{
                  // alignItems:'flex-end',
                  zIndex:1}} />
                </View>
                  </TouchableOpacity>
                  ...
                  <Text style={{textAlign:"center",color:"#FFFFFF",fontSize:20,}}>{"Select your Friends"}</Text>
                   ...
                   <TouchableOpacity style={{height:40,justifyContent:"center",marginRight:5}} onPress={()=>{this.setState({modalVisible:false},()=>{this.oncloseModal(true)});}}>
