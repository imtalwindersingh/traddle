...
import RegistrationTraderVerfiyPAge from '../../components/Registration/RegistrationTraderVerify';
...
class RegistrationTraderVerify extends Component {
	  	...
	  	<View style={{flex:1,backgroundColor:color.mainbackground,}}>	 
            ...
            <View style={{flexDirection:'row',paddingLeft:20,paddingTop:10,height:50,alignItems:'center'}}>
              ...
              <TouchableOpacity onPress={()=>{this.props.navigation.goBack()}} style={{flexDirection:'row',alignItems:'center'}}>
                ...
                <Text style={{marginLeft:20,textAlign:'center',fontSize:20,fontFamily:'Roboto-Bold',color:'#000',marginRight:10}}>Current Trade</Text>
              </TouchableOpacity>

            </View>
  	         	
              <RegistrationTraderVerfiyPAge 
